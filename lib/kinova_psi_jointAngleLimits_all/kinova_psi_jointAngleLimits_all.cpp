...
//
// kinova_psi_jointAngleLimits_all.cpp
//
// Code generation for function 'kinova_psi_jointAngleLimits_all'
//

// Include files
#include "kinova_psi_jointAngleLimits_all.h"

// Function Definitions
void kinova_psi_jointAngleLimits_all(double q1, double q2, double q3, double q4,
                                     double q5, double q6, double q7,
                                     double q1max, double q2max, double q3max,
                                     double q4max, double q5max, double q6max,
                                     double q7max, double q1min, double q2min,
                                     double q3min, double q4min, double q5min,
                                     double q6min, double q7min, double psi[7])
{
  double psi_tmp;
  double t32;
  double t33;
  ...
  double t42;
  double t43;
  // KINOVA_PSI_JOINTANGLELIMITS_ALL
  //     PSI =
  //     KINOVA_PSI_JOINTANGLELIMITS_ALL(Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q1MIN,Q2MIN,Q1MAX,Q3MIN,Q2MAX,Q4MIN,Q3MAX,Q5MIN,Q4MAX,Q6MIN,Q5MAX,Q7MIN,Q6MAX,Q7MAX)
  //     This function was generated by the Symbolic Math Toolbox version 8.7.
  //     16-Jun-2023 12:51:19
  t32 = q2 + -q2min;
  t33 = q2 + -q2max;
  t34 = q3 + -q3min;
  t35 = q3 + -q3max;
...
// End of code generation (kinova_psi_jointAngleLimits_all.cpp)
