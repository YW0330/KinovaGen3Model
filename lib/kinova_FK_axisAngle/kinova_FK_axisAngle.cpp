...
//
// kinova_FK_axisAngle.cpp
//
// Code generation for function 'kinova_FK_axisAngle'
//

// Include files
#include "kinova_FK_axisAngle.h"
#include "rotm2axang.h"
#include "rt_nonfinite.h"
#include <cmath>

// Function Definitions
void kinova_FK_axisAngle(double q1, double q2, double q3, double q4, double q5,
                         double q6, double q7, double X[7])
{
  double b_t15[16];
  double c_t15[9];
  double d_t15[4];
  ...
  X[5] = theta0e[2];
  X[6] = theta0e[3];
  //  7x1 xyz add axis angle
}

// End of code generation (kinova_FK_axisAngle.cpp)
